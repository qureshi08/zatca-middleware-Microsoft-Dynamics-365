    ...
    return (
        <aside className="sidebar shadow-2xl">
            ...
            {user ? (
                <>
                    <div className="mb-8 p-4 bg-orange-50 rounded-2xl border border-orange-100">
                        ...
                        <p className="text-[13px] font-bold text-gray-900 truncate">Business Central Connection</p>
                    </div>
                    ...
                    <nav className="flex-1 space-y-6 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 280px)' }}>
                        <div>
                            ...
                            <Link href="/admin/bc/settings" className={`nav-item${isActive('/admin/bc/settings') ? ' active' : ''}`}>
                ...
                <div className="flex-1 flex flex-col gap-5 pt-2 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 220px)' }}>
                    <div className="p-5 bg-orange-50 rounded-2xl border border-orange-100 text-center">
                        <h3 className="text-[12px] font-extrabold text-orange-800 mb-1.5 uppercase tracking-wider">Business Central ZATCA Gateway</h3>
                        <p className="text-[10px] text-orange-700/80 mb-4 leading-relaxed">Sign in or register your organization to link your Dynamics 365 Business Central environment to the ZATCA e-invoicing service.</p>
                        ...
                        <Link href="/register?intent=bc" className="block mt-2 text-[10px] text-orange-700 font-bold hover:underline">Register Business →</Link>
                    </div>
                </div>
            )}
            ...
            <div className="mt-auto pt-6 border-t border-gray-50">
                ...
                <p className="text-[9px] text-gray-300 font-bold uppercase tracking-widest">Version 1.0.0 · Business Central Node</p>
            </div>
        </aside>
    );
}
