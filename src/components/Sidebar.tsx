                ...
                <>
                    ...
                    <nav className="flex-1 space-y-8">
                        ...
                        <div className="pt-4 mt-4 border-t border-gray-100">
                            <div className="nav-label text-blue-600">Product Portal</div>
                            <Link href="/bank/login" className="nav-item group border border-blue-50 bg-blue-50/30 hover:bg-black hover:text-white transition-all">
                                <div className="w-4 h-4 bg-blue-600 rounded flex items-center justify-center text-[10px] text-white font-black group-hover:bg-white group-hover:text-black">B</div>
                                Bank Side Demo
                            </Link>
                        </div>
                    </nav>
