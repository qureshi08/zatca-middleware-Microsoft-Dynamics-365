        ...
        <div className="container">
          <div className="max-w-2xl mx-auto text-center space-y-12">
            <div className="card-pro p-10 bg-white border-2 border-dashed border-gray-100 flex flex-col items-center">
              ...
              <h1 className="h1 mb-2">Connect Business Central Integration</h1>
              <p className="body-text text-sm max-w-md mx-auto mb-8">Welcome to the ZATCA Middleware. Your Business Central gateway is active but no integration credentials have been set up yet.</p>

              <Link href="/admin/bc/settings" className="btn-pro h-12 px-10 bg-orange-600 hover:scale-105 transition-transform shadow-2xl shadow-orange-500/20 text-white font-bold flex items-center justify-center">
                Configure Business Central Settings
              </Link>
      ...
      <div className="animate-pro section-pro">
        <div className="container">
          <div className="card-pro p-10 bg-amber-50 border-amber-100 text-center max-w-lg mx-auto">
            ...
            <Link href="/admin/bc/settings" className="btn-pro bg-amber-500 text-white font-bold flex items-center justify-center">Configure Business Central</Link>
          </div>
        </div>
      </div>
    );
      ...
      <section className="section-pro border-b border-gray-100 bg-[#fbfbfd]">
        <div className="container">
          <div className="flex items-center justify-between gap-4">
            <div>
              <h1 className="h1 mb-1">Business Central Sync Center</h1>
            ...
            <div className="flex gap-2">
              <Link href="/admin/bc/settings" className="btn-pro bg-orange-600 text-white font-bold">
            ...
            <div className="space-y-3">
              ...
              <div className="card-pro p-3 bg-white space-y-2">
                ...
                <div className="flex justify-between items-center py-1 border-b border-gray-100">
                  ...
                  <span className="text-[13px] font-black">Business Central Node</span>
                </div>
                <div className="flex justify-between items-center py-1 border-b border-gray-50">
