 ...
 * Supports an optional ?intent=bc query so Business Central-initiated
 * registrations land on the Business Central onboarding flow after the first
 * sign-in rather than the generic dashboard.
 */
...
function RegisterContent() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Always forward to Business Central Settings after registration/login for this integration
            const next = '/admin/bc/settings';
            ...
            <div className="w-full max-w-xl relative z-10">
                <div className="text-center mb-10">
                    ...
                    <p className="text-gray-400 text-sm">
                        Create your tenant on the ZATCA Middleware. After this you'll run ZATCA compliance and then connect Business Central.
                    </p>
                </div>
